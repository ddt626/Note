...
namespace MethodDemo04
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TestClass z = ChangeX(ref y);
            Console.WriteLine("退出 ChangeX 方法回到 Main 方法後,y 實體中的 x 的值為 " + y.x.ToString());
            Console.WriteLine("ChangeX 回傳的實體中的 x 的值為 " + z.x.ToString());
            Console.ReadLine();
        }
